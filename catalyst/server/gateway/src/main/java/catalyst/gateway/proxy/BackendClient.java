...
public final class BackendClient implements AutoCloseable {
    ...
    public CompletableFuture<GatewayFrame> requestAsync(GatewayFrame frame, Consumer<GatewayControlMessage> controlCallback) {
    ...
    private void sendOnStreamAsync(GatewayFrame outbound, CompletableFuture<GatewayFrame> future, Consumer<GatewayControlMessage> controlCallback) {
