...
1. Start server dependencies (e.g., PostgreSQL container).
2. Boot server.
...
- [x] E2E harness exists and runs locally in one command.
- [x] CI workflow executes E2E harness on PRs.
- [x] Failing E2E blocks merge.
- [x] Failure output includes enough diagnostics to triage quickly.
